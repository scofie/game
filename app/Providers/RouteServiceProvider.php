...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @return void
     */
    public function mapAdminRoute(Router $router)
    {
        $domain = \Config::get('domain');
     ...
     * @return void
     */
    public function mapWapRoute(Router $router)
    {
        Route::group(['prefix' => '/', 'namespace' => $this->namespace], function ($router) {
